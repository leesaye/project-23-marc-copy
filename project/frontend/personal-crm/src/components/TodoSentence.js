...
function TodoSentence() {
    ...
    const promptStart = "Order these Events and Tasks in terms of priority on when I should complete them. Make them into 1 simple sentence that makes it very clear on the best order to complete them in. Do not use any special formatting except for new line characters. Start off with a nice uplifting greeting message prepping me on the tasks I have to complete. Also say something along the lines of, here is the best way to complete your upcoming tasks. Something along those lines but on exactly. Mix it up! Add some /\n/ between the message and the plans. Avoid trying to do items at the same time. Don't make the intro too long."
