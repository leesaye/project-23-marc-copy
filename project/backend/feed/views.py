...
class UserStatsViewSet(viewsets.ModelViewSet):
    ...
    def increment_count(self, request):
        ...
        user_stats.save()
        return Response({'message': 'Daily count incremented', 'current_daily_count': user_stats.current_daily_count})
